...
/** MySQL settings **/
define('MF_DB_NAME', 'cbr'); //The name of your database. Note that this database must exist before running installer.php
define('MF_DB_USER', 'cbr'); //Your database username
define('MF_DB_PASSWORD', 'yb3jfMfAC4uZpScw'); //Your database users password
