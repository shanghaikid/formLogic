...
EOT;
	...
	function mf_display_form($dbh,$form_id,$form_params=array()){	
		...
		$form->logic_data 			= $row['form_logic_data'];
...
EOT;
			...
			$theme_url = $machform_path.'js/lib/dijit/themes/soria/soria.css';
...
.addRule button{color:#080; font-weight: 700; font-size: 14px;}
.removeRule button{color:#C30; font-weight: 700;  font-size: 14px;}
.dijitDialogPaneContent { width: 550px !important;height: 250px !important;}
...
<body id="main_body" class="soria {$container_class}">
	...
	<script type="text/javascript" src="{$machform_path}/js/lib/dojo/dojo.js"></script>
	<script>
		require(["src/FormLogic"], function(FormLogic){
			new FormLogic({el: document.getElementById('form_container'), addLogic: true});
